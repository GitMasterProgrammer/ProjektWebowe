...
export default function ActivityButton({ reportId, isFollowed }: ActivityButtonProps) {
    ...
    return (
        <button className={`btn ${isFollowing ? "btn-danger" : "btn-primary"}`} onClick={isFollowing ? UnFollow : Follow}>
